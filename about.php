...
<html lang="en">
   ...
   <body class="main-layout inner_header about_page">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div>
                              <a href="index.php"><p style="color: rgb(243, 175, 49); font-size:27px; font-weight:700; padding-bottom:10px; text-align: left;">EthioTutoring</p></a>
                           </div>
                        </div>
                     </div>
                  </div>
     ...
     <div class="yellow_darkbg">
            ...
            <div class="row d_flex">
               ...
               <div class="col-md-6">
                ...
                <div class="col-md-5 offset-md-1" style="margin-top: 10px;">
                  <div class="team_img">
                     <figure><img src="images/customImage3.jpg" alt="#" style="border-radius: 10px;"/></figure>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="team" style="padding-top: 5px; padding-bottom: 5px; margin-top: 90px;">
         <div class="container">
            <div class="row d_flex">
              
               <div class="col-md-6">
                  <div class="team_img">
                     <figure><img src="images/customImage2.jpg" alt="#" style="border-radius: 10px; height: 300px; width: 500px;"/></figure>
                  </div>
               </div>
                <div class="col-md-5 offset-md-1" style="margin-top: 10px;">
                  <div class="titlepage">
                     <h2>What We Do?</h2>
                     <p>Our tutors work with a curriculum expert to assure that they are able to offer their students multiple modalities to completely grasp the content that they are struggling with.</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="team" style="padding-top: 5px; padding-bottom: 5px;  margin-top: 90px; margin-bottom: 50px;">
         <div class="container">
            <div class="row d_flex">
               ...
               <div class="col-md-6">
                  <div class="titlepage">
                     <h2>Our Goal</h2>
                     <p>Our goal is to give your student the confidence and tools necessary to be a successful student.</p>
                  </div>
               </div>
                <div class="col-md-5 offset-md-1">
                  <div class="team_img">
                     <figure><img src="images/customImage1.jpg" alt="#" style="border-radius: 10px; height: 300px; width: 500px;"/></figure>
                  </div>
               </div>
            </div>
         </div>
